...
myDispatchVect4 = DispatchVect4.DispatchVect4()
myFloatDiv1 = FloatDiv.FloatDiv()
myFloatDiv2 = FloatDiv.FloatDiv()
myLog = Log.Log()
myClamp = Clamp.Clamp()
myMix = Mix.Mix()
...
# creation des liens values = assignation des valeurs constantes
